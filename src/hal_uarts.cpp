...
void init(void)
{
	...
	Chip_UART_SetRS485Flags(LPC_USART3, UART_RS485CTRL_DCTRL_EN | UART_RS485CTRL_OINV_1);
	Chip_UART_SetRS485Delay(LPC_USART3, 200);
}
...
{
	if(n == 1)			return Chip_UART_SendRB(LPC_UART1,  &txBuffer1, data, size);
