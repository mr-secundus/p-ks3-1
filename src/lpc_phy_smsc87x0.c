...
/*
 * 05.03.2025  РП  Отладочная версия инициализации PHY - lpc_phy_init().
 * 
 * Скопирован код из emac.c проекта SK_LPC4337_TEST/EasyWeb.
 * Полная инициализация PHY, чтение PHY ID, autonegotiation, link status control.    
 */
