...
unsigned short UpdateCRC16(unsigned char Octet,unsigned short CRC)
{
 return  Crc16Table[ (CRC >> 8) & 255] ^ (CRC << 8) ^ Octet;
}

unsigned short UpdateCRC(unsigned char Octet,unsigned short CRC)
{
