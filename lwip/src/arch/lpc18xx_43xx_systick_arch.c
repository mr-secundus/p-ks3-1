 ...
 * RP @ sk4337_udp_io
 * 
 * SysTick_Handler() implemented in src/hal.cpp
 * SysTick_Handler() increment systick_timems 
 * 
 * At this file:
 *   - SysTick_Handler() removed
 *   - disable operations w/peripherial at SysTick_Enable() SysTick_Disable()
 ******************************************************************************/
